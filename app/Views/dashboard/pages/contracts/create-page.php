                            ...
                            <div class="col-md-12">
                                ...
                                <div v-for="(design,index) in Real_estate_unit_room_item_detail.designs" class="col-md-4">
                                    ...
                                    <div class="box box-widget widget-user">
                                        ...
                                        <input disabled @click="selectThisDesign(design, k, Real_estate_unit_room_item_detail.designs)" class="img-circle" type="checkbox" name="design_title" :id="'design_title'+k+design.design_price_id"><label :for="'design_title'+k+design.design_price_id">{{design.design_title}}</label>
            ...
            <div class="box box-primary">
                ...
                <form role="form" method="post">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <textarea name="contract_details" id="editor1" cols="30" rows="50" class="form-control">
                                    <?= ($orderData['contract_details']) ? $orderData['contract_details'] : DefaultContract() ?>
...
This agreement shall be governed by and construed in accordance with the laws of [Jurisdiction]. Any disputes arising under this agreement shall be resolved through arbitration in [Arbitration Location]. -->
                    ...
                    <div class="box-footer">
                        <button type="submit" @click="saveData()" class="btn btn-primary pull-right">
