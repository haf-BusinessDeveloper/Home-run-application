        ...
        <div class="col-md-7">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Create a new room type</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" name="room_type_title" id="room_type_title" placeholder="Enter room type title">
                        </div>
                    </div>
                    <!-- /.box-body -->
