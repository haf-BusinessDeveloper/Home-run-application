                        ...
                        <tbody>
                            <?php foreach ($records as $key => $record) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('dashboard/settings/roomtypes/show/') ?><?= $record['room_type_id'] ?>">
                                            <button class="btn btn-xs btn-primary">
                                                <i class="fa fa-eye"></i> View
                                            </button>
                                        </a>
                                        <a href="<?= base_url('dashboard/settings/roomtypes/update/') ?><?= $record['room_type_id'] ?>">
                                            <button class="btn btn-xs btn-warning">
                                                <i class="fa fa-edit"></i> Edit
                                            </button>
                                        </a>
                                        <a href="<?= base_url('dashboard/settings/roomtypes/delete/') ?><?= $record['room_type_id'] ?>">
