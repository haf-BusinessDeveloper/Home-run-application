      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('public/dashboard') ?>/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?= base_url('public/dashboard') ?>/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="<?= base_url('public/dashboard') ?>/dist/img/user1-128x128.jpg" alt="Message User Image"><!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-msg right">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="<?= base_url('public/dashboard') ?>/dist/img/user3-128x128.jpg" alt="Message User Image"><!-- /.direct-chat-img -->
                  <div class="direct-chat-text">
              ...
              <div class="direct-chat-contacts">
                <ul class="contacts-list">
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="<?= base_url('public/dashboard') ?>/dist/img/user1-128x128.jpg" alt="User Image">
      ...
      <div class="row">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              <div class="widget-user-image">
                <img class="img-circle" src="<?= base_url('public/dashboard') ?>/dist/img/user7-128x128.jpg" alt="User Avatar">
              </div>
              <!-- /.widget-user-image -->
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-image">
              <img class="img-circle" src="<?= base_url('public/dashboard') ?>/dist/img/user1-128x128.jpg" alt="User Avatar">
            </div>
            <div class="box-footer">
              <div class="row">
          ...
          <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block">
                <img class="img-circle" src="<?= base_url('public/dashboard') ?>/dist/img/user1-128x128.jpg" alt="User Image">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <img class="img-responsive pad" src="<?= base_url('public/dashboard') ?>/dist/img/photo2.png" alt="Photo">
            ...
            <div class="box-footer box-comments">
              <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="<?= base_url('public/dashboard') ?>/dist/img/user3-128x128.jpg" alt="User Image">
              ...
              <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="<?= base_url('public/dashboard') ?>/dist/img/user4-128x128.jpg" alt="User Image">
            ...
            <div class="box-footer">
              <form action="#" method="post">
                <img class="img-responsive img-circle img-sm" src="<?= base_url('public/dashboard') ?>/dist/img/user4-128x128.jpg" alt="Alt Text">
          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
              ...
              <div class="attachment-block clearfix">
                <img class="attachment-img" src="<?= base_url('public/dashboard') ?>/dist/img/photo1.png" alt="Attachment Image">
            ...
            <div class="box-footer box-comments">
              ...
              <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="<?= base_url('public/dashboard') ?>/dist/img/user5-128x128.jpg" alt="User Image">
