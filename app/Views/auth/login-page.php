...
<head>
  ...
  <title>Home Run Application | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= base_url('public/dashboard') ?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url() ?>"><b>Home Run </b>Application</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?= base_url('public/dashboard') ?>/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
